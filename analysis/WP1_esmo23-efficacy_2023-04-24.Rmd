...
# TREATMENT GROUP B (ITT population)
## iDFS RATE
...
### Save plot ---------------------------------------------------------------
ggsave(
  here("output/PHERGain_Figure1_iDFS_groupB_ITT_2023-04-27.png"),
  idfs_groupB_itt,
  width = 24,
  height = 12,
  units = "cm",
...
## iDFS RATE IN PET-RESPONDERS WHO ACHIEVED A PCR
...
### Save plot ---------------------------------------------------------------
ggsave(
  here("output/PHERGain_Figure2_iDFS_groupB_ITT_PET-responders-pCR_2023-04-27.png"),
...
## iDFS RATE BY HORMONE RECEPTOR STATUS
...
os_groupB_itt
```
# TREATMENT GROUP A (ITT population)
## iDFS RATE
