...
# summary(survfit(Surv(time, event) ~ 1, data = data_01b_groupB_idfs_itt))
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + strata(hormone_receptor_status), data = data_01b_groupB_idfs_itt), times = 36)
```
...
### Save plot ---------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure1_iDFS_groupB_ITT_2023-05-26.png"),
#   idfs_groupB_itt,
#   width = 24,
#   height = 12,
#   units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ 1 + strata(hormone_receptor_status), data = data_01c_groupB_idfs_pet_pcr), times = 36)
```
...
### Save plot ---------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure2_iDFS_groupB_ITT_PET-responders-pCR_2023-05-26.png"),
#   idfs_groupB_idfs_pet_pcr,
#   width = 24,
#   height = 12,
#   units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_02b_groupB_idfs_pp), times = 36)
```
...
### Save plot ---------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure3_iDFS_groupB_PP_2023-04-27.png"),
#   idfs_groupB_pp,
#   width = 24,
#   height = 12,
#   units = "cm",
...
### Save plot --------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure4_iDFS_groupB_ITT_by-HR_2023-04-27.png"),
#   idfs_groupB_itt_hr,
#   width = 24,
#   height = 12,
#   units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ nodal_status, data = data_01b_groupB_idfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ ihc, data = data_01b_groupB_idfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_03a_groupB_dfs_itt), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_03a_groupB_dfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_temp), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_03_groupB_ddfs_itt), times = 36)
```
...
### Save plot ---------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure5_DDFS_groupB_ITT_2023-04-27.png"),
#   ddfs_groupB_itt,
#   width = 24,
#   height = 12,
#   units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_03b_groupB_ddfs_pet_pcr), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_03b_groupB_ddfs_pet_pcr), times = 36)
```
...
ddfs_groupB_pet_pcr <- ggsurvplot(
  fit = survfit(Surv(time, event) ~ 1, data = data_03b_groupB_ddfs_pet_pcr),
  xlab = "Time since surgery (months)", 
  ylab = "Distant Disease-Free Survival",
  conf.int = TRUE,
  conf.int.alpha = c(0.15),
...
```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_04_groupB_efs_itt), times = 36)
```
...
### Save plot ---------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure6_EFS_groupB_ITT_2023-04-27.png"),
#   efs_groupB_itt,
#   width = 24,
#   height = 12,
#   units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_04b_groupB_efs_pet_pcr), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_04b_groupB_efs_pet_pcr), times = 36)
```
...
efs_groupB_pet_pcr <- ggsurvplot(
  fit = survfit(Surv(time, event) ~ 1, data = data_04b_groupB_efs_pet_pcr),
  xlab = "Time since surgery (months)", 
  ylab = "Event-Free Survival",
  conf.int = TRUE,
  conf.int.alpha = c(0.15),
...
```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_05_groupB_os_itt), times = 36)
```
...
### Save plot ---------------------------------------------------------------
# ggsave(
#   here("output/PHERGain_Figure7_OS_groupB_ITT_2023-04-27.png"),
#   os_groupB_itt,
#   width = 24,
#   height = 12,
#   units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_05b_groupB_efs_pet_pcr), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_05b_groupB_efs_pet_pcr), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_06b_groupA_idfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_07_groupA_ddfs_itt), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_07_groupA_ddfs_itt), times = 36)
```

#### Kaplan-Meier plot

## 2.4 Event-Free Survival (EFS) analysis
### 2.4.1 EFS rate in group B
#### Data preprocessing
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_08_groupA_efs_itt), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_08_groupA_efs_itt), times = 36)
```
...
efs_groupA_itt <- ggsurvplot(
  fit = survfit(Surv(time, event) ~ 1, data = data_08_groupA_efs_itt),
  xlab = "Time since surgery (months)", 
  ylab = "Event-Free Survival",
  conf.int = TRUE,
  conf.int.alpha = c(0.15),
...
```{r}
summary(survfit(Surv(time, event) ~ 1, data = data_09_groupA_os_itt), times = 36)
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ 1 + hormone_receptor_status, data = data_09_groupA_os_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group, data = data_10b_group_idfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_10b_group_idfs_itt), times = 36)
```
...
### 3.3.1 DDFS rate in group B
#### Data preprocessing

```{r}
data_11_group_ddfs_itt <- data_10a_group %>% 
  filter(
    discontinuation_study_treatment_before_surgery == "No",
    surgery_performed == "Yes"
  ) %>% 
...
```{r}
# summary(survfit(Surv(time, event) ~ group, data = data_11_group_ddfs_itt), times = 36)
```

#### Log rank test p value

```{r}
logrank_ddfs <- survdiff(Surv(time, event) ~ group, data = data_11_group_ddfs_itt)
logrank_ddfs[6]
```
...
```{r}
# summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_11_group_ddfs_itt), times = 36)
```

#### Stratified log rank test p value

```{r}
logrank_idfs <- survdiff(Surv(time, event) ~ group + hormone_receptor_status, data = data_11_group_ddfs_itt)
logrank_idfs[6]
```

## 3.4 Event-Free Survival (EFS) analysis
### 3.4.1 EFS rate in group B
#### Data preprocessing

```{r}
data_12_group_efs_itt <- data_10a_group %>% 
  select(
    subject_id, group, hormone_receptor_status, pet_response_conclusion, p_cr_yp_t0_is_n0,
    efs, efs_time_years, follow_up_time_time_from_randomization_to_last_contact_date_years
  ) %>% 
...
data_12_group_efs_itt$time <- data_12_group_efs_itt$time * 12
  
summary(data_12_group_efs_itt$fu)

rmarkdown::paged_table(data_12_group_efs_itt)
```

#### Estimation of 3-year survival

```{r}
summary(survfit(Surv(time, event) ~ group, data = data_12_group_efs_itt), times = 36)
```

```{r}
# logrank_ddfs <- survdiff(Surv(time, event) ~ group, data = data_12_group_efs_itt)
# logrank_ddfs[6]

summary(coxph(Surv(time, event) ~ group + strata(hormone_receptor_status), data = data_12_group_efs_itt, ties = "breslow"))
```

#### Stratified Cox regression

```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_12_group_efs_itt), times = 36)
```

```{r}
logrank_idfs <- survdiff(Surv(time, event) ~ group + hormone_receptor_status, data = data_12_group_efs_itt)
logrank_idfs[6]
```

## 3.5 Overall Survival (OS) analysis
### 3.5.1 OS rate in group B
#### Data preprocessing

```{r}
data_13_group_os_itt <- data_10a_group %>% 
  select(
    subject_id, group, hormone_receptor_status, pet_response_conclusion, p_cr_yp_t0_is_n0,
    os, os_time_years, follow_up_time_time_from_randomization_to_last_contact_date_years
  ) %>% 
...
data_13_group_os_itt$time <- data_13_group_os_itt$time * 12
  
summary(data_13_group_os_itt$fu)

rmarkdown::paged_table(data_13_group_os_itt)
```

#### Estimation of 3-year survival

```{r}
summary(survfit(Surv(time, event) ~ group, data = data_13_group_os_itt), times = 36)
```

#### Log rank test p value

```{r}
logrank_ddfs <- survdiff(Surv(time, event) ~ group, data = data_13_group_os_itt)
logrank_ddfs[6]
```
...
```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_13_group_os_itt), times = 36)
```

#### Stratified log rank test p value

```{r}
logrank_idfs <- survdiff(Surv(time, event) ~ group + hormone_receptor_status, data = data_13_group_os_itt)
logrank_idfs[6]
```
