...
### Save plot ---------------------------------------------------------------
ggsave(
  here("output/PHERGain_Figure1_iDFS_groupB_ITT_2023-06-23.png"),
  idfs_groupB_itt,
  width = 20,
  height = 12,
  units = "cm",
...
### Save plot ---------------------------------------------------------------
ggsave(
  here("output/PHERGain_Figure2_iDFS_groupB_ITT_PET-responders-pCR_2023-06-23.png"),
  idfs_groupB_idfs_pet_pcr,
  width = 20,
  height = 12,
  units = "cm",
...
```{r}
summary(survfit(Surv(time, event) ~ group, data = data_11b_group_dfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_11b_group_dfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group, data = data_12_group_ddfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_12_group_ddfs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group, data = data_13_group_efs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_13_group_efs_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group, data = data_14_group_os_itt), times = 36)
```
...
```{r}
summary(survfit(Surv(time, event) ~ group + hormone_receptor_status, data = data_14_group_os_itt), times = 36)
```
